...
function init(){
    ...
    if (!books || books.length === 0) {
        ...
        books = JSON.parse(JSON.stringify(booksJson));
    }
...
var booksJson = [
    {
      ...
      "publishedDate": 1999,
      "description": "placerat nisi sodales hello world blablablabablabblgfgfhfghfghfgfghffga ttttttttttttttttttttttttt bla bla bala bl suscipit tellus tincidunt mauris elit sit luctus interdum ad dictum platea vehicula conubia fermentum habitasse congue suspendisse",
      "pageCount": 713,
      "categories": [
        "Computers",
        "Hack"
